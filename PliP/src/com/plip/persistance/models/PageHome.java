 ...
 * @see com.plip.persistance.models.Page
...
public class PageHome {
	...
	public Page merge(Page detachedInstance) {
		...
		try {
			Page result = (Page) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Page findById(long id) {
		...
		try {
			Page instance = (Page) sessionFactory.getCurrentSession().get(
					"com.plip.persistance.models.Page", id);
			if (instance == null) {
	...
	public List findByExample(Page instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistance.models.Page")
