 ...
 * @see com.plip.persistance.models.PageProduct
...
public class PageProductHome {
	...
	public PageProduct findById(com.plip.persistance.models.PageProductId id) {
		log.debug("getting PageProduct instance with id: " + id);
		try {
			PageProduct instance = (PageProduct) sessionFactory
					.getCurrentSession().get(
							"com.plip.persistance.models.PageProduct", id);
			if (instance == null) {
	...
	public List findByExample(PageProduct instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistance.models.PageProduct")
