...
import com.plip.persistence.models.Status;

/**
 * Home object for domain model class Status.
 * @see com.plip.persistence.models.Status
	...
	public Status findById(java.lang.Integer id) {
		...
		try {
			Status instance = (Status) sessionFactory.getCurrentSession().get(
					"com.plip.persistence.models.Status", id);
			if (instance == null) {
	...
	public List findByExample(Status instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistence.models.Status")
