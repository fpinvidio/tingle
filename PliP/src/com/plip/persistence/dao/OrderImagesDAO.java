...
public class OrderImagesDAO {
	...
	private static final Log log = LogFactory.getLog(OrderImagesDAO.class);
		...
		try {
			OrderImages instance = (OrderImages) sessionFactory
					.getCurrentSession().get(
							"com.plip.persistance.models.OrderImages", id);
			if (instance == null) {
	...
	public List findByExample(OrderImages instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistance.models.OrderImages")
