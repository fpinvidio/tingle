...
import com.plip.persistence.models.User;

/**
 * Home object for domain model class User.
 * @see com.plip.persistence.models.User
	...
	public User findById(java.lang.Long id) {
		...
		try {
			User instance = (User) sessionFactory.getCurrentSession().get(
					"com.plip.persistance.models.User", id);
			if (instance == null) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistance.models.User")
