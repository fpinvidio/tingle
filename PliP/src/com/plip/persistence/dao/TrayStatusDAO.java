...
import com.plip.persistence.models.TrayStatusId;
 ...
 */
public class TrayStatusDAO {

	private static final Log log = LogFactory.getLog(TrayStatusDAO.class);
		...
		try {
			TrayStatus instance = (TrayStatus) sessionFactory
					.getCurrentSession().get(
							"com.plip.persistance.models.TrayStatus", id);
			if (instance == null) {
	...
	public List findByExample(TrayStatus instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistance.models.TrayStatus")
