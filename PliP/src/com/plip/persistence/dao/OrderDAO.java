...
import com.plip.persistence.models.Order;

/**
 * Home object for domain model class Order.
 * @see com.plip.persistence.models.Order
	...
	public Order findById(java.lang.Long id) {
		...
		try {
			Order instance = (Order) sessionFactory.getCurrentSession().get(
					"com.plip.persistance.models.Order", id);
			if (instance == null) {
	...
	public List findByExample(Order instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistance.models.Order")
