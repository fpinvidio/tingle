...
import com.plip.persistence.models.Position;

/**
 * Home object for domain model class Position.
 * @see com.plip.persistence.models.Position
	...
	public Position findById(int id) {
		...
		try {
			Position instance = (Position) sessionFactory.getCurrentSession()
					.get("com.plip.persistence.models.Position", id);
			if (instance == null) {
	...
	public List findByExample(Position instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.plip.persistence.models.Position")
